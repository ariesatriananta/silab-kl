...
export const borrowingTransactions = pgTable(
  "borrowing_transactions",
  {
    ...
    approvalRound: integer("approval_round").default(1).notNull(),
...
export const borrowingApprovals = pgTable(
  ...
  (t) => [
    ...
    index("borrowing_approvals_tx_round_idx").on(t.transactionId, t.approvalRound),
    uniqueIndex("borrowing_approvals_tx_approver_uq").on(t.transactionId, t.approverUserId, t.approvalRound),
    uniqueIndex("borrowing_approvals_tx_step_uq").on(t.transactionId, t.stepOrder, t.approvalRound),
  ],
)
